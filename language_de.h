...
#define THIS_LANGUAGES_SPECIAL_SYMBOLS      _UxGT("鑴涚洸鑴版灇鑴虹湁鑴借檹椴�")

#define WELCOME_MSG                         MACHINE_NAME _UxGT(" bereit")
#define MSG_BACK                            _UxGT("Zur鐪塩k")
...
#define MSG_MAIN                            _UxGT("Hauptmen鐪�")
...
#define MSG_LEVEL_BED_WAITING               _UxGT("Klick f鐪塺 Start")
#define MSG_LEVEL_BED_NEXT_POINT            _UxGT("N鐩瞔hste Koordinate")
#define MSG_LEVEL_BED_DONE                  _UxGT("Fertig")
#define MSG_Z_FADE_HEIGHT                   _UxGT("Niv. Ausblendh鏋歨e")
#define MSG_SET_HOME_OFFSETS                _UxGT("Setze Homeversatz")
#define MSG_HOME_OFFSETS_APPLIED            _UxGT("Homeversatz aktiv")
#define MSG_SET_ORIGIN                      _UxGT("Setze Nullpunkt") //"G92 X0 Y0 Z0" commented out in ultralcd.cpp
#define MSG_PREHEAT_1                       _UxGT("Vorw鐩瞨men PLA")
#define MSG_PREHEAT_1_N                     _UxGT("Vorw鐩瞨men PLA ")
...
#define MSG_PREHEAT_2                       _UxGT("Vorw鐩瞨men ABS")
#define MSG_PREHEAT_2_N                     _UxGT("Vorw鐩瞨men ABS ")
...
#define MSG_COOLDOWN                        _UxGT("Abk鐪塰len")
...
#define MSG_USER_MENU                       _UxGT("Benutzer Men鐪�")
...
#define MSG_NOZZLE                          _UxGT("D鐪塻e")
#define MSG_BED                             _UxGT("Bett")
#define MSG_FAN_SPEED                       _UxGT("L鐪塮ter")
...
#define MSG_SELECT                          _UxGT("Ausw鐩瞙len")
...
#define MSG_ERR_MAXTEMP                     LCD_STR_THERMOMETER _UxGT(" 鑴築ERSCHRITTEN")
#define MSG_ERR_MINTEMP                     LCD_STR_THERMOMETER _UxGT(" UNTERSCHRITTEN")
#define MSG_ERR_MAXTEMP_BED                 _UxGT("BETT ") LCD_STR_THERMOMETER _UxGT(" 鑴築ERSCHRITTEN")
...
#define MSG_DELTA_HEIGHT_CALIBRATE          _UxGT("Delta H鏋歨e setzen")

#define MSG_INFO_MENU                       _UxGT("鑴篵er den Drucker")
...
#define MSG_UBL_DOING_G29                 _UxGT("G29 UBL l鐩瞮ft!")
...
#define MSG_UBL_MOVING_TO_NEXT            _UxGT("N鐩瞔hster Punkt...")
...
#define MSG_UBL_MESH_HEIGHT_ADJUST        _UxGT("Netz H鏋歨e einst.")
...
#define MSG_UBL_OUTPUT_MAP_HOST           _UxGT("Ausgabe f鐪塺 Host")
#define MSG_UBL_OUTPUT_MAP_CSV            _UxGT("Ausgabe f鐪塺 CSV")
...
#define MSG_UBL_INVALIDATE_CLOSEST        _UxGT("N鐩瞔hstlieg. ann.")
#define MSG_UBL_FINE_TUNE_ALL             _UxGT("Feineinstellung Alle")
#define MSG_UBL_FINE_TUNE_CLOSEST         _UxGT("Feineinst. N鐩瞔hstl.")
...
#define MSG_UBL_STEP_BY_STEP_MENU         _UxGT("Schrittweises UBL")
  ...
  #define MSG_INFO_PRINT_LONGEST            _UxGT("L鐩瞡gster Druckjob")
  ...
  #define MSG_INFO_PRINT_LONGEST            _UxGT("L鐩瞡gster")
...
#define MSG_DRIVE_STRENGTH                  _UxGT("Motorstr鏋歮e")
...
#define MSG_FILAMENT_CHANGE_NOZZLE          _UxGT("  D鐪塻e: ")
  ...
  #define MSG_FILAMENT_CHANGE_INSERT_3        _UxGT("dr鐪塩ken...")
  #define MSG_FILAMENT_CHANGE_HEAT_1          _UxGT("Knopf dr鐪塩ken um")
  #define MSG_FILAMENT_CHANGE_HEAT_2          _UxGT("D鐪塻e aufzuheizen.")
  #define MSG_FILAMENT_CHANGE_HEATING_1       _UxGT("D鐪塻e heizt auf...")
