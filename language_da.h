...
#define MSG_DISABLE_STEPPERS                _UxGT("Sl姘� alle steppere fra")
#define MSG_AUTO_HOME                       _UxGT("Auto Home") // G28
#define MSG_AUTO_HOME_X                     _UxGT("Home X")
#define MSG_AUTO_HOME_Y                     _UxGT("Home Y")
#define MSG_AUTO_HOME_Z                     _UxGT("Home Z")
#define MSG_LEVEL_BED_HOMING                _UxGT("Homing XYZ")
#define MSG_LEVEL_BED_WAITING               _UxGT("Klik n姘搑 du er klar")
#define MSG_LEVEL_BED_NEXT_POINT            _UxGT("N蹇檚te punkt")
#define MSG_LEVEL_BED_DONE                  _UxGT("Bed level er f蹇檙dig!")
#define MSG_SET_HOME_OFFSETS                _UxGT("S蹇檛 forsk. af home")
#define MSG_HOME_OFFSETS_APPLIED            _UxGT("Forsk. er nu aktiv")
#define MSG_SET_ORIGIN                      _UxGT("S蹇檛 origin")
...
#define MSG_COOLDOWN                        _UxGT("Afk閰秎")
#define MSG_SWITCH_PS_ON                    _UxGT("Sl姘� str閰秏 til")
#define MSG_SWITCH_PS_OFF                   _UxGT("Sl姘� str閰秏 fra")
...
#define MSG_FAN_SPEED                       _UxGT("Bl蹇檚er hastighed")
...
#define MSG_MOTION                          _UxGT("Bev蹇檊else")
...
#define MSG_USERWAIT                        _UxGT("Venter p姘� bruger...")
#define MSG_RESUMING                        _UxGT("Fors蹇檛ter printet")
#define MSG_PRINT_ABORTED                   _UxGT("Print annulleret")
#define MSG_NO_MOVE                         _UxGT("Ingen bev蹇檊else.")
#define MSG_KILLED                          _UxGT("DR鑴滲T. ")
#define MSG_STOPPED                         _UxGT("STOPPET. ")
#define MSG_CONTROL_RETRACT                 _UxGT("Tilbagetr蹇檏 mm")
#define MSG_CONTROL_RETRACT_SWAP            _UxGT("Skift Re.mm")
#define MSG_CONTROL_RETRACTF                _UxGT("Tilbagetr蹇檏 V")
...
#define MSG_THERMAL_RUNAWAY                 _UxGT("Temp l閰禸er l閰禸sk")
...
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Fors蹇檛 print")

#if LCD_HEIGHT >= 4
  #define MSG_FILAMENT_CHANGE_INIT_1          _UxGT("Vent p姘� start")
  #define MSG_FILAMENT_CHANGE_INIT_2          _UxGT("af filament")
  #define MSG_FILAMENT_CHANGE_INIT_3          _UxGT("skift")
  #define MSG_FILAMENT_CHANGE_UNLOAD_1        _UxGT("Vent p姘�")
  #define MSG_FILAMENT_CHANGE_UNLOAD_2        _UxGT("filament udskyd.")
  #define MSG_FILAMENT_CHANGE_INSERT_1        _UxGT("Inds蹇檛 filament")
  #define MSG_FILAMENT_CHANGE_INSERT_2        _UxGT("og tryk p姘� knap")
  #define MSG_FILAMENT_CHANGE_INSERT_3        _UxGT("for at forts蹇檛te...")
  #define MSG_FILAMENT_CHANGE_LOAD_1          _UxGT("Vent p姘�")
  #define MSG_FILAMENT_CHANGE_LOAD_2          _UxGT("filament indtag")
  #define MSG_FILAMENT_CHANGE_EXTRUDE_1       _UxGT("Vent p姘�")
  #define MSG_FILAMENT_CHANGE_EXTRUDE_2       _UxGT("filament extrudering")
  #define MSG_FILAMENT_CHANGE_RESUME_1        _UxGT("Vent p姘� at print")
  #define MSG_FILAMENT_CHANGE_RESUME_2        _UxGT("forts蹇檛ter")
#else // LCD_HEIGHT < 4
  #define MSG_FILAMENT_CHANGE_INIT_1          _UxGT("Vent venligst...")
  #define MSG_FILAMENT_CHANGE_UNLOAD_1        _UxGT("Udskyder...")
  #define MSG_FILAMENT_CHANGE_INSERT_1        _UxGT("Inds蹇檛 og klik")
  #define MSG_FILAMENT_CHANGE_LOAD_1          _UxGT("Indtager...")
  #define MSG_FILAMENT_CHANGE_EXTRUDE_1       _UxGT("Extrudere...")
  #define MSG_FILAMENT_CHANGE_RESUME_1        _UxGT("Forts蹇檛ter...")
#endif // LCD_HEIGHT < 4
