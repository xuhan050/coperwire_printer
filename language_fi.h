...
#define MSG_PREHEAT_1                       _UxGT("Esil鐩瞞mit鐩� PLA")
#define MSG_PREHEAT_1_N                     _UxGT("Esil鐩瞞mit鐩� PLA ")
#define MSG_PREHEAT_1_ALL                   _UxGT("Esil鐩�. PLA Kaikki")
#define MSG_PREHEAT_1_BEDONLY               _UxGT("Esil鐩�. PLA Alusta")
#define MSG_PREHEAT_1_SETTINGS              _UxGT("Esil鐩瞞m. PLA konf")
#define MSG_PREHEAT_2                       _UxGT("Esil鐩瞞mit鐩� ABS")
#define MSG_PREHEAT_2_N                     _UxGT("Esil鐩瞞mit鐩� ABS ")
#define MSG_PREHEAT_2_ALL                   _UxGT("Esil鐩�. ABS Kaikki")
#define MSG_PREHEAT_2_BEDONLY               _UxGT("Esil鐩�. ABS Alusta")
#define MSG_PREHEAT_2_SETTINGS              _UxGT("Esil鐩瞞m. ABS konf")
#define MSG_COOLDOWN                        _UxGT("J鐩茬洸hdyt鐩�")
#define MSG_SWITCH_PS_ON                    _UxGT("Virta p鐩茬洸lle")
#define MSG_SWITCH_PS_OFF                   _UxGT("Virta pois")
#define MSG_EXTRUDE                         _UxGT("Pursota")
#define MSG_RETRACT                         _UxGT("Ved鐩� takaisin")
...
#define MSG_TEMPERATURE                     _UxGT("L鐩瞞p鏋歵ila")
#define MSG_MOTION                          _UxGT("Liike")
#define MSG_FILAMENT                        _UxGT("Filament")
#define MSG_VOLUMETRIC_ENABLED              _UxGT("E in mm椴�")
...
#define MSG_REFRESH                         _UxGT("P鐩瞚vit鐩�")
#define MSG_WATCH                           _UxGT("Seuraa")
#define MSG_PREPARE                         _UxGT("Valmistele")
#define MSG_TUNE                            _UxGT("S鐩茬洸d鐩�")
#define MSG_PAUSE_PRINT                     _UxGT("Keskeyt鐩� tulostus")
#define MSG_RESUME_PRINT                    _UxGT("Jatka tulostusta")
#define MSG_STOP_PRINT                      _UxGT("Pys鐩瞴t鐩� tulostus")
...
#define MSG_CONTROL_RETRACT                 _UxGT("Ved鐩� mm")
#define MSG_CONTROL_RETRACT_SWAP            _UxGT("Va. Ved鐩� mm")
#define MSG_CONTROL_RETRACTF                _UxGT("Ved鐩� V")
