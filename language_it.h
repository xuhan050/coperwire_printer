...
#define MSG_VELOCITY                        _UxGT("Velocit鑴�")
...
#define MSG_CASE_LIGHT_BRIGHTNESS           _UxGT("Luminosit鑴� Luci")
  ...
  #define MSG_INFO_PRINT_LONGEST            _UxGT("Lavoro pi闇� lungo")
  ...
  #define MSG_INFO_PRINT_LONGEST            _UxGT("Pi闇� lungo")
...
#define MSG_FILAMENT_CHANGE_MINTEMP         _UxGT("Temp minima 鐚� ")
