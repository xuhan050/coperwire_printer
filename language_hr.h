...
#define MSG_LEVEL_BED_WAITING               _UxGT("Klikni za po鑶積tak")
#define MSG_LEVEL_BED_NEXT_POINT            _UxGT("Sljede鑶癮 to鑶穔a")
...
#define MSG_SET_ORIGIN                      _UxGT("Postavi ishodi鎷e")
...
#define MSG_COOLDOWN                        _UxGT("Hla鑶絜nje")
#define MSG_SWITCH_PS_ON                    _UxGT("Uklju鑶穒 napajanje")
#define MSG_SWITCH_PS_OFF                   _UxGT("Isklju鑶穒 napajanje")
#define MSG_EXTRUDE                         _UxGT("Extrude")
#define MSG_RETRACT                         _UxGT("Retract")
#define MSG_MOVE_AXIS                       _UxGT("Mi鑶穒 os")
#define MSG_BED_LEVELING                    _UxGT("Niveliraj bed")
#define MSG_LEVEL_BED                       _UxGT("Niveliraj bed")
#define MSG_MOVE_X                          _UxGT("Mi鑶穒 X")
#define MSG_MOVE_Y                          _UxGT("Mi鑶穒 Y")
#define MSG_MOVE_Z                          _UxGT("Mi鑶穒 Z")
#define MSG_MOVE_E                          _UxGT("Extruder")
#define MSG_MOVE_01MM                       _UxGT("Mi鑶穒 0.1mm")
#define MSG_MOVE_1MM                        _UxGT("Mi鑶穒 1mm")
#define MSG_MOVE_10MM                       _UxGT("Mi鑶穒 10mm")
...
#define MSG_LOAD_EEPROM                     _UxGT("U鑶穒taj memoriju")
#define MSG_RESTORE_FAILSAFE                _UxGT("U鑶穒taj failsafe")
#define MSG_REFRESH                         _UxGT("Osvje鍟猧")
...
#define MSG_USERWAIT                        _UxGT("鑶秂kaj korisnika...")
...
#define MSG_HEATING_FAILED_LCD              _UxGT("Grijanje neuspje鎷o")
...
#define MSG_DELTA_CALIBRATE_CENTER          _UxGT("Kalibriraj Sredi鎷e")
...
#define MSG_CASE_LIGHT                      _UxGT("Osvjetljenje")
  ...
  #define MSG_INFO_COMPLETED_PRINTS         _UxGT("Zavr鎷ni")
  #define MSG_INFO_PRINT_TIME               _UxGT("Ukupno printanja")
  #define MSG_INFO_PRINT_LONGEST            _UxGT("Najdu鍟猧 print")
  ...
  #define MSG_INFO_PRINT_LONGEST            _UxGT("Najdu鍟猧")
...
#define MSG_FILAMENT_CHANGE_OPTION_EXTRUDE  _UxGT("Extrudiraj vi鎷")
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Nastavi print")

#if LCD_HEIGHT >= 4
  // Up to 3 lines allowed
  #define MSG_FILAMENT_CHANGE_INIT_1          _UxGT("鑶秂kaj po鑶積tak")
  #define MSG_FILAMENT_CHANGE_INIT_2          _UxGT("filamenta")
  #define MSG_FILAMENT_CHANGE_INIT_3          _UxGT("promijeni")
  #define MSG_FILAMENT_CHANGE_UNLOAD_1        _UxGT("鑶秂kaj")
  ...
  #define MSG_FILAMENT_CHANGE_LOAD_1          _UxGT("Pri鑶積kaj")
  #define MSG_FILAMENT_CHANGE_LOAD_2          _UxGT("filament load")
  #define MSG_FILAMENT_CHANGE_EXTRUDE_1       _UxGT("Pri鑶積kaj")
  #define MSG_FILAMENT_CHANGE_EXTRUDE_2       _UxGT("filament extrude")
  #define MSG_FILAMENT_CHANGE_RESUME_1        _UxGT("Wait for print")
  #define MSG_FILAMENT_CHANGE_RESUME_2        _UxGT("to resume")
#else // LCD_HEIGHT < 4
  // Up to 2 lines allowed
  #define MSG_FILAMENT_CHANGE_INIT_1          _UxGT("Pri鑶積kaj...")
