...
#define MSG_SD_INSERTED                     _UxGT("Karta w鑹俹鍋秓na")
#define MSG_SD_REMOVED                      _UxGT("Karta usuni鑷媡a")
#define MSG_LCD_ENDSTOPS                    _UxGT("Kranc璐竪.") // Max length 8 characters
#define MSG_MAIN                            _UxGT("Menu g鑹傝锤wne")
#define MSG_AUTOSTART                       _UxGT("Autostart")
#define MSG_DISABLE_STEPPERS                _UxGT("Wy鑹傝啴cz silniki")
...
#define MSG_LEVEL_BED                       _UxGT("Poziom. sto鑹倁")
#define MSG_LEVEL_BED_HOMING                _UxGT("Pozycja zerowa")
#define MSG_LEVEL_BED_WAITING               _UxGT("Kliknij by rozp.")
#define MSG_LEVEL_BED_NEXT_POINT            _UxGT("Nast鑷媝ny punkt")
...
#define MSG_PREHEAT_1_BEDONLY               _UxGT("Rozgrzej st璐歌墏 PLA")
...
#define MSG_PREHEAT_2_BEDONLY               _UxGT("Rozgrzej st璐歌墏 ABS")
#define MSG_PREHEAT_2_SETTINGS              _UxGT("Ustaw. rozg. ABS")
#define MSG_COOLDOWN                        _UxGT("Ch鑹俹dzenie")
#define MSG_SWITCH_PS_ON                    _UxGT("W鑹傝啴cz zasilacz")
#define MSG_SWITCH_PS_OFF                   _UxGT("Wy鑹傝啴cz zasilacz")
#define MSG_EXTRUDE                         _UxGT("Ekstruzja")
#define MSG_RETRACT                         _UxGT("Wycofanie")
#define MSG_MOVE_AXIS                       _UxGT("Ruch osi")
#define MSG_BED_LEVELING                    _UxGT("Poziom. sto鑹倁")
#define MSG_MOVE_X                          _UxGT("Przesu鑹� w X")
#define MSG_MOVE_Y                          _UxGT("Przesu鑹� w Y")
#define MSG_MOVE_Z                          _UxGT("Przesu鑹� w Z")
#define MSG_MOVE_E                          _UxGT("Ekstruzja (os E)")
#define MSG_MOVE_01MM                       _UxGT("Przesu鑹� co .1mm")
#define MSG_MOVE_1MM                        _UxGT("Przesu鑹� co 1mm")
#define MSG_MOVE_10MM                       _UxGT("Przesu鑹� co 10mm")
#define MSG_SPEED                           _UxGT("Predko鑹ｈ啺")
#define MSG_BED_Z                           _UxGT("St璐歌墏 Z")
#define MSG_NOZZLE                          _UxGT("Dysza")
#define MSG_BED                             _UxGT("St璐歌墏")
#define MSG_FAN_SPEED                       _UxGT("Obroty wiatraka")
#define MSG_FLOW                            _UxGT("Przep鑹倅w")
#define MSG_CONTROL                         _UxGT("Ustawienia")
#define MSG_MIN                             LCD_STR_THERMOMETER _UxGT(" Min")
#define MSG_MAX                             LCD_STR_THERMOMETER _UxGT(" Max")
#define MSG_FACTOR                          LCD_STR_THERMOMETER _UxGT(" Mno鍋秐ik")
#define MSG_AUTOTEMP                        _UxGT("Auto. temperatura")
#define MSG_ON                              _UxGT("W鑹�. ")
#define MSG_OFF                             _UxGT("Wy鑹�.")
#define MSG_PID_P                           _UxGT("PID-P")
#define MSG_PID_I                           _UxGT("PID-I")
#define MSG_PID_D                           _UxGT("PID-D")
#define MSG_PID_C                           _UxGT("PID-C")
#define MSG_SELECT                          _UxGT("Select")
#define MSG_ACC                             _UxGT("Przy鑹ieszenie")
...
#define MSG_A_TRAVEL                        _UxGT("A-przesu鑹�.")
...
#define MSG_FILAMENT_DIAM                   _UxGT("鑹. fil.")
#define MSG_CONTRAST                        _UxGT("Kontrast LCD")
#define MSG_STORE_EEPROM                    _UxGT("Zapisz w pami鑷媍i")
#define MSG_LOAD_EEPROM                     _UxGT("Wczytaj z pami鑷媍i")
#define MSG_RESTORE_FAILSAFE                _UxGT("Ustaw. fabryczne")
#define MSG_REFRESH                         _UxGT("Odswie鍋�")
#define MSG_WATCH                           _UxGT("Ekran g鑹傝锤wny")
...
#define MSG_FILAMENTCHANGE                  _UxGT("Zmie鑹� filament")
#define MSG_INIT_SDCARD                     _UxGT("Inicjal. karty SD")
#define MSG_CNG_SDCARD                      _UxGT("Zmiana karty SD")
#define MSG_ZPROBE_OUT                      _UxGT("Sonda Z za sto鑹俥m")
...
#define MSG_ENDSTOP_ABORT                   _UxGT("B鑹傝啴d kra鑹卌璐竪ki")
#define MSG_HEATING_FAILED_LCD              _UxGT("Rozgrz. nieudane")
#define MSG_ERR_REDUNDANT_TEMP              _UxGT("B鑹傝啴d temperatury")
...
#define MSG_ERR_MAXTEMP_BED                 _UxGT("Err max temp sto鑹倁")
#define MSG_ERR_MINTEMP_BED                 _UxGT("Err min temp sto鑹倁")
#define MSG_ERR_Z_HOMING                    _UxGT("G28 Z Forbidden")
#define MSG_HALTED                          _UxGT("Drukarka zatrzym.")
#define MSG_PLEASE_RESET                    _UxGT("Prosz鑷� zresetowa鑶�")
...
#define MSG_BED_HEATING                     _UxGT("Rozgrzewanie sto鑹倁...")
#define MSG_BED_DONE                        _UxGT("Rozgrzano st璐歌墏")
...
#define MSG_DELTA_CALIBRATE_CENTER          _UxGT("Kalibruj 鑹odek")
...
#define MSG_INFO_BAUDRATE                   _UxGT("Predko鑹ｈ啺 USB")
#define MSG_INFO_PROTOCOL                   _UxGT("Protok璐歌墏")
#define MSG_CASE_LIGHT                      _UxGT("O鑹ietlenie")

#if LCD_WIDTH >= 20
  #define MSG_INFO_PRINT_COUNT              _UxGT("Wydrukowano")
  #define MSG_INFO_COMPLETED_PRINTS         _UxGT("Uko鑹卌zono")
  #define MSG_INFO_PRINT_TIME               _UxGT("Czas druku")
  #define MSG_INFO_PRINT_LONGEST            _UxGT("Najd鑹�. druk")
  #define MSG_INFO_PRINT_FILAMENT           _UxGT("U鍋秠ty fil.")
#else
  #define MSG_INFO_PRINT_COUNT              _UxGT("Wydrukowano")
  #define MSG_INFO_COMPLETED_PRINTS         _UxGT("Uko鑹卌zono")
...
#define MSG_DRIVE_STRENGTH                  _UxGT("Si鑹俛 silnika")
#define MSG_DAC_PERCENT                     _UxGT("Si鑹俛 %")
#define MSG_DAC_EEPROM_WRITE                _UxGT("Zapisz DAC EEPROM")

#define MSG_FILAMENT_CHANGE_HEADER          _UxGT("ZMIE鑹� FILAMENT")
#define MSG_FILAMENT_CHANGE_OPTION_HEADER   _UxGT("ZMIE鑹� OPCJE:")
#define MSG_FILAMENT_CHANGE_OPTION_EXTRUDE  _UxGT("Ekstruduj wi鑷媍ej")
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Wzn璐竪 drukowanie")

#if LCD_HEIGHT >= 4
  // Up to 3 lines allowed
  #define MSG_FILAMENT_CHANGE_INIT_1          _UxGT("Czekam na ")
  #define MSG_FILAMENT_CHANGE_INIT_2          _UxGT("zmian鑷� filamentu")
  #define MSG_FILAMENT_CHANGE_UNLOAD_1        _UxGT("Czekam na")
  #define MSG_FILAMENT_CHANGE_UNLOAD_2        _UxGT("wyj鑷媍ie filamentu")
  #define MSG_FILAMENT_CHANGE_INSERT_1        _UxGT("W鑹傝锤z filament")
  #define MSG_FILAMENT_CHANGE_INSERT_2        _UxGT("i naci鑹ij przycisk")
  #define MSG_FILAMENT_CHANGE_INSERT_3        _UxGT("aby kontynuowa鑶�...")
  #define MSG_FILAMENT_CHANGE_LOAD_1          _UxGT("Czekam na")
  #define MSG_FILAMENT_CHANGE_LOAD_2          _UxGT("w鑹俹鍋秂nie filamentu")
  #define MSG_FILAMENT_CHANGE_EXTRUDE_1       _UxGT("Czekam na")
  #define MSG_FILAMENT_CHANGE_EXTRUDE_2       _UxGT("ekstruzj鑷� filamentu")
  #define MSG_FILAMENT_CHANGE_RESUME_1        _UxGT("Czekam na")
  #define MSG_FILAMENT_CHANGE_RESUME_2        _UxGT("wznowienie druku")
#else // LCD_HEIGHT < 4
  // Up to 2 lines allowed
  #define MSG_FILAMENT_CHANGE_INIT_1          _UxGT("Prosz鑷� czeka鑶�...")
  #define MSG_FILAMENT_CHANGE_UNLOAD_1        _UxGT("Wysuwanie...")
  #define MSG_FILAMENT_CHANGE_INSERT_1        _UxGT("W鑹傝锤鍋� i naci鑹ij prz.")
  #define MSG_FILAMENT_CHANGE_LOAD_1          _UxGT("鑹乤dowanie...")
