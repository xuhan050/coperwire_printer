...
#define MAPPER_C2C3  // because of "璐�"
...
#define MSG_MAIN                            _UxGT("Men鐓� principal")
...
#define MSG_LEVEL_BED_NEXT_POINT            _UxGT("Seg鐪塭nt punt")
...
#define MSG_INFO_MIN_TEMP                   _UxGT("Temp. m閾唍ima")
#define MSG_INFO_MAX_TEMP                   _UxGT("Temp. m鑴縳ima")
#define MSG_INFO_PSU                        _UxGT("Font alimentacio")

#define MSG_DRIVE_STRENGTH                  _UxGT("For鑾絘 motor")
#define MSG_DAC_PERCENT                     _UxGT("Driver %")
#define MSG_DAC_EEPROM_WRITE                _UxGT("DAC EEPROM Write")
#define MSG_FILAMENT_CHANGE_HEADER          _UxGT("PRINT PAUSED")
#define MSG_FILAMENT_CHANGE_OPTION_HEADER   _UxGT("RESUME OPTIONS:")
#define MSG_FILAMENT_CHANGE_OPTION_EXTRUDE  _UxGT("Extrudeix mes")
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Repren impressi璐�")
