...
#define WELCOME_MSG                         MACHINE_NAME _UxGT(" pr閿歵e.")
#define MSG_BACK                            _UxGT("Retour")
#define MSG_SD_INSERTED                     _UxGT("Carte ins鑼卹鑼卐")
#define MSG_SD_REMOVED                      _UxGT("Carte retir鑼卐")
#define MSG_LCD_ENDSTOPS                    _UxGT("But鑼卐s") // Max length 8 characters
#define MSG_MAIN                            _UxGT("Menu principal")
#define MSG_AUTOSTART                       _UxGT("Demarrage auto")
#define MSG_DISABLE_STEPPERS                _UxGT("Arr閿歵er moteurs")
...
#define MSG_LEVEL_BED_DONE                  _UxGT("Mise 鑴� niveau OK!")
#define MSG_Z_FADE_HEIGHT                   _UxGT("Adoucir hauteur")
#define MSG_SET_HOME_OFFSETS                _UxGT("Regl. d鑼卌al. origine")
#define MSG_HOME_OFFSETS_APPLIED            _UxGT("D鑼卌alages appliqu鑼卻")
#define MSG_SET_ORIGIN                      _UxGT("R鑼単ler origine")
#define MSG_PREHEAT_1                       _UxGT("Pr鑼卌hauffage PLA")
#define MSG_PREHEAT_1_N                     _UxGT("Pr鑼卌hauff. PLA ")
#define MSG_PREHEAT_1_ALL                   _UxGT("Pr鑼卌h. PLA Tout")
#define MSG_PREHEAT_1_END                   MSG_PREHEAT_1 _UxGT(" fini")
#define MSG_PREHEAT_1_BEDONLY               _UxGT("Pr鑼卌h. PLA lit")
#define MSG_PREHEAT_1_SETTINGS              _UxGT("Regl. prech. PLA")
#define MSG_PREHEAT_2                       _UxGT("Pr鑼卌hauffage ABS")
#define MSG_PREHEAT_2_N                     _UxGT("Pr鑼卌hauff. ABS ")
#define MSG_PREHEAT_2_ALL                   _UxGT("Pr鑼卌h. ABS Tout")
#define MSG_PREHEAT_2_END                   MSG_PREHEAT_2 _UxGT(" fini")
#define MSG_PREHEAT_2_BEDONLY               _UxGT("Pr鑼卌h. ABS lit")
...
#define MSG_SWITCH_PS_OFF                   _UxGT("鑴eindre alim.")
#define MSG_EXTRUDE                         _UxGT("鑴trusion")
#define MSG_RETRACT                         _UxGT("R鑼卼raction")
#define MSG_MOVE_AXIS                       _UxGT("D鑼卲lacer un axe")
#define MSG_BED_LEVELING                    _UxGT("R鐚玤l. Niv. lit")
#define MSG_LEVEL_BED                       _UxGT("R鐚玤l. Niv. lit")
#define MSG_EDITING_STOPPED                 _UxGT("Arr閿歵 edit. maillage")
...
#define MSG_UBL_LEVEL_BED                   _UxGT("Niveau lit unifi鑼�")
#define MSG_UBL_MANUAL_MESH                 _UxGT("Maillage manuel")
#define MSG_UBL_BC_INSERT                   _UxGT("Poser c鑺抣e & mesurer")
#define MSG_UBL_BC_INSERT2                  _UxGT("Mesure")
#define MSG_UBL_BC_REMOVE                   _UxGT("涔坱er et mesurer lit")
#define MSG_UBL_MOVING_TO_NEXT              _UxGT("Aller au suivant")
#define MSG_UBL_ACTIVATE_MESH               _UxGT("Activer l'UBL")
#define MSG_UBL_DEACTIVATE_MESH             _UxGT("D鑼卻activer l'UBL")
#define MSG_UBL_SET_BED_TEMP                _UxGT("Temp鑼卹ature lit")
#define MSG_UBL_CUSTOM_BED_TEMP             MSG_UBL_SET_BED_TEMP
#define MSG_UBL_SET_HOTEND_TEMP             _UxGT("Temp鑼卹ature buse")
#define MSG_UBL_CUSTOM_HOTEND_TEMP          MSG_UBL_SET_HOTEND_TEMP
#define MSG_UBL_EDIT_CUSTOM_MESH            _UxGT("Editer maille perso")
#define MSG_UBL_FINE_TUNE_MESH              _UxGT("R鑼単lage fin maille")
#define MSG_UBL_DONE_EDITING_MESH           _UxGT("Termier maille")
#define MSG_UBL_BUILD_CUSTOM_MESH           _UxGT("Cr鑼卐r maille perso")
#define MSG_UBL_BUILD_MESH_MENU             _UxGT("Cr鑼卐r maille")
#define MSG_UBL_BUILD_PLA_MESH              _UxGT("Cr鑼卐r maille PLA")
#define MSG_UBL_BUILD_ABS_MESH              _UxGT("Cr鑼卐r maille ABS")
#define MSG_UBL_BUILD_COLD_MESH             _UxGT("Cr鑼卐r maille froide")
...
#define MSG_UBL_INVALIDATE_CLOSEST          _UxGT("Annuler le plus pr鐚玸")
#define MSG_UBL_FINE_TUNE_ALL               _UxGT("R鑼単lage fin (tous)")
#define MSG_UBL_FINE_TUNE_CLOSEST           _UxGT("R鑼単lage fin (proche)")
#define MSG_UBL_STORAGE_MESH_MENU           _UxGT("Stockage maille")
#define MSG_UBL_STORAGE_SLOT                _UxGT("Slot m鑼卪oire")
...
#define MSG_UBL_Z_OFFSET_STOPPED            _UxGT("Offset Z arr閿歵鑼�")


#define MSG_MOVING                          _UxGT("D鑼卲lacement...")
#define MSG_FREE_XY                         _UxGT("D鑼卋loquer XY")
#define MSG_MOVE_X                          _UxGT("D鑼卲l. X")
#define MSG_MOVE_Y                          _UxGT("D鑼卲l. Y")
#define MSG_MOVE_Z                          _UxGT("D鑼卲l. Z")
#define MSG_MOVE_E                          _UxGT("Extruder")
#define MSG_MOVE_01MM                       _UxGT("D鑼卲l. 0.1mm")
#define MSG_MOVE_1MM                        _UxGT("D鑼卲l. 1mm")
#define MSG_MOVE_10MM                       _UxGT("D鑼卲l. 10mm")
...
#define MSG_CONTROL                         _UxGT("Contr涔坙er")
...
#define MSG_OFF                             _UxGT("Arr閿歵")
#define MSG_PID_P                           _UxGT("PID-P")
#define MSG_PID_I                           _UxGT("PID-I")
#define MSG_PID_D                           _UxGT("PID-D")
#define MSG_PID_C                           _UxGT("PID-C")
#define MSG_SELECT                          _UxGT("S鑼卨ectionner")
#define MSG_ACC                             _UxGT("Acc鑼卨鑼卹ation")
#define MSG_JERK                            _UxGT("Jerk")
#define MSG_VX_JERK                         _UxGT("Vx-jerk")
#define MSG_VY_JERK                         _UxGT("Vy-jerk")
#define MSG_VZ_JERK                         _UxGT("Vz-jerk")
#define MSG_VE_JERK                         _UxGT("Ve-jerk")
#define MSG_VELOCITY                        _UxGT("V鑼卨ocit鑼�")
#define MSG_VMAX                            _UxGT("Vmax")
#define MSG_VMIN                            _UxGT("Vmin")
#define MSG_VTRAV_MIN                       _UxGT("Vdepl min")
#define MSG_ACCELERATION                    _UxGT("Acc鑼卨鑼卹ation")
#define MSG_AMAX                            _UxGT("Amax ")
#define MSG_A_RETRACT                       _UxGT("A-retract")
#define MSG_A_TRAVEL                        _UxGT("A-D鑼卲l.")
...
#define MSG_TEMPERATURE                     _UxGT("Temp鑼卹ature")
...
#define MSG_PRINT_ABORTED                   _UxGT("Impr. Annul鑼卐")
#define MSG_NO_MOVE                         _UxGT("Moteurs bloqu鑼卻.")
#define MSG_KILLED                          _UxGT("MORT.")
#define MSG_STOPPED                         _UxGT("STOPP鑴�.")
#define MSG_CONTROL_RETRACT                 _UxGT("Retraction mm")
#define MSG_CONTROL_RETRACT_SWAP            _UxGT("Ech. Retr. mm")
#define MSG_CONTROL_RETRACTF                _UxGT("R鑼卼raction V")
...
#define MSG_AUTORETRACT                     _UxGT("R鑼卼ract. Auto.")
#define MSG_FILAMENTCHANGE                  _UxGT("Changer filament")
#define MSG_INIT_SDCARD                     _UxGT("Init. la carte SD")
#define MSG_CNG_SDCARD                      _UxGT("Changer de carte")
#define MSG_ZPROBE_OUT                      _UxGT("Z sonde ext鐚�. lit")
#define MSG_BLTOUCH                         _UxGT("BLTouch")
#define MSG_BLTOUCH_SELFTEST                _UxGT("Autotest BLTouch")
#define MSG_BLTOUCH_RESET                   _UxGT("RaZ BLTouch")
#define MSG_BLTOUCH_DEPLOY                  _UxGT("D鑼卲loyer BLTouch")
...
#define MSG_ZPROBE_ZOFFSET                  _UxGT("D鑼卌alage Z")
#define MSG_BABYSTEP_X                      _UxGT("Babystep X")
#define MSG_BABYSTEP_Y                      _UxGT("Babystep Y")
#define MSG_BABYSTEP_Z                      _UxGT("Babystep Z")
#define MSG_ENDSTOP_ABORT                   _UxGT("But鑼卐 abandon")
...
#define MSG_HALTED                          _UxGT("IMPR. STOPP鑴")
...
#define MSG_HEATING_COMPLETE                _UxGT("Chauffe termin鑼卐")
#define MSG_BED_HEATING                     _UxGT("Lit en chauffe..")
#define MSG_BED_DONE                        _UxGT("Chauffe lit termin鑼卐")
...
#define MSG_3POINT_LEVELING                 _UxGT("Niveau 鑴� 3 points")
#define MSG_LINEAR_LEVELING                 _UxGT("Niveau lin鑼卆ire")
#define MSG_BILINEAR_LEVELING               _UxGT("Niveau bilin鑼卆ire")
#define MSG_UBL_LEVELING                    _UxGT("Niveau lit unifi鑼�")
...
#define MSG_CASE_LIGHT                      _UxGT("Lumi鐚玶e caisson")
#define MSG_CASE_LIGHT_BRIGHTNESS           _UxGT("Luminosit鑼�")

#if LCD_WIDTH >= 20
  #define MSG_INFO_PRINT_COUNT              _UxGT("Nbre impressions")
  #define MSG_INFO_COMPLETED_PRINTS         _UxGT("Termin鑼卐s")
...
#define MSG_FILAMENT_CHANGE_NOZZLE          _UxGT("  Buse: ")
  ...
  #define MSG_FILAMENT_CHANGE_INIT_1        _UxGT("Attente D鑼卪arrage")
  ...
  #define MSG_FILAMENT_CHANGE_UNLOAD_2      _UxGT("d鑼卌harger filament")
  #define MSG_FILAMENT_CHANGE_INSERT_1      _UxGT("ins鑼卹er filament")
  ...
  #define MSG_FILAMENT_CHANGE_INSERT_1      _UxGT("Ins鑼卹er et clic")
