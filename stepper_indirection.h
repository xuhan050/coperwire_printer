...
//HANXU: fengzhuang
#define H_STEP_INIT SET_OUTPUT(E1_STEP_PIN)
#define H_STEP_WRITE(v) WRITE(E1_STEP_PIN,v);
#define H_STEP_READ READ(E1_STEP_PIN)

#define H_DIR_INIT SET_OUTPUT(E1_DIR_PIN) 
#define H_DIR_WRITE(STATE) WRITE(E1_DIR_PIN,STATE)
#define H_DIR_READ READ(E1_DIR_PIN)
 ...
 */
  ...
  #define REV_E_DIR() { switch (current_block->active_extruder) { case 0: E0_DIR_WRITE(INVERT_E0_DIR); break; case 1: E1_DIR_WRITE(INVERT_E1_DIR); break; case 2: E2_DIR_WRITE(INVERT_E2_DIR); } }
    ...
    #define REV_E_DIR() { if (current_block->active_extruder == 0) { E0_DIR_WRITE(INVERT_E0_DIR); } else { E1_DIR_WRITE(INVERT_E1_DIR); } } //executed when extruder =2
  #endif// NOTICE instruction flow
  ...
  #endif
#else
  #define E_STEP_WRITE(v) E0_STEP_WRITE(v)  //executed when extruder =1
