...
class Stepper {
  ...
  private:
    ...
    static long counter_X, counter_Y, counter_Z, counter_H, counter_E;
    ...
    //
    static volatile long count_position[XYZE_AD];

    //
    // Current direction of stepper motors (+1 or -1)
    //
    static volatile signed char count_direction[XYZE_AD];//HANXU
  ...
  public:
    ...
    //
    static void set_position_AD(const long &a, const long &b, const long &c, const long &e,const long &h);
