...
#define MSG_DISABLE_STEPPERS                _UxGT("闂傛粓鏋嗗銉╋拷鏌ワ龚閸曪拷")  //"Disable steppers"
...
#define MSG_LEVEL_BED_HOMING                _UxGT("楠炲啿褰寸懢鍨挬XYZ濮濈甯担锟�")  //"Homing XYZ"
...
#define MSG_A_RETRACT                       _UxGT("閺�鍫曪拷鎻掑闁喎瀹�")  //"A-retract" retract_acceleration, E acceleration in mm/s^2 for retracts
...
#define MSG_MOTION                          _UxGT("闁瀚�")  //"Motion"
...
#define MSG_LOAD_EEPROM                     _UxGT("鐟佹繆绱氱懛顓犵枂")  //"Load memory"
#define MSG_RESTORE_FAILSAFE                _UxGT("閹垼顦�瑰鍙忛崐锟�")  //"Restore failsafe"
...
#define MSG_RESUME_PRINT                    _UxGT("閹垼顦崚妤�宓�")  //"Resume print"
...
#define MSG_RESUMING                        _UxGT("閹垼顦崚妤�宓冩稉锟�")  //"Resuming print"
#define MSG_PRINT_ABORTED                   _UxGT("閸掓宓冨鎻掑絿濞戯拷")  //"Print aborted"
#define MSG_NO_MOVE                         _UxGT("閻掞紕些閸曪拷")  //"No move."
#define MSG_KILLED                          _UxGT("瀹稿弶顔戦幒锟�")  //"KILLED. "
#define MSG_STOPPED                         _UxGT("瀹告彃浠犲锟�")  //"STOPPED. "
#define MSG_CONTROL_RETRACT                 _UxGT("閸ョ偞濞婇梹宄板mm")  //"Retract mm" retract_length, retract length (positive mm)
...
#define MSG_CONTROL_RETRACT_RECOVER         _UxGT("閸ョ偞濞婇幁銏ｎ槵闂�宄板mm")  //"UnRet +mm" retract_recover_length, additional recover length (mm, added to retract length when recovering)
#define MSG_CONTROL_RETRACT_RECOVER_SWAP    _UxGT("閹绘稒澧滈崶鐐村▕閹垼顦梹宄板mm")  //"S UnRet+mm" swap_retract_recover_length, additional swap recover length (mm, added to retract length when recovering from extruder change)
#define MSG_CONTROL_RETRACT_RECOVERF        _UxGT("閸ョ偞濞婇幁銏ｎ槵瀵板矂锟藉弶鏋￠柅鐔哄芳mm/s")  //"UnRet  V" retract_recover_feedrate_mm_s, feedrate for recovering from retraction (mm/s)
#define MSG_AUTORETRACT                     _UxGT("閼奉亜瀚婇幎钘夋礀")  //"AutoRetr." autoretract_enabled,
...
#define MSG_INFO_PRINTER_MENU               _UxGT("閸楁媽銆冨鐔朵繆閹拷")  //"Printer Info"
...
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("閹垼顦崚妤�宓�")  //"Resume print"
...
#define MSG_FILAMENT_CHANGE_INSERT_3        _UxGT("娓氬棛杈滅痪锟� ...")  //"to continue..."
...
#define MSG_FILAMENT_CHANGE_RESUME_2        _UxGT("閹垼顦�")  //"to resume"
...
#define MSG_FILAMENT_CHANGE_INSERT_1        _UxGT("閹绘帒鍙嗘稉锕�鏌堥幙锟�")  //"Insert and Click"
#define MSG_FILAMENT_CHANGE_LOAD_1          _UxGT("鐟佹繆绱氭稉锟� ...")  //"Loading..."
#define MSG_FILAMENT_CHANGE_EXTRUDE_1       _UxGT("閹跨姴鍤稉锟� ...")  //"Extruding..."
#define MSG_FILAMENT_CHANGE_RESUME_1        _UxGT("閹垼顦稉锟� ...")  //"Resuming..."
#endif // LCD_HEIGHT < 4
